...
parser.add_argument('--rgb-list', default='shanghai-i3d-train-10crop.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='shanghai-i3d-test-10crop.list', help='list of test rgb features ')
parser.add_argument('--gt', default='gt-sh.npy', help='file of ground truth ')
parser.add_argument('--gpus', default=1, type=int, choices=[0], help='gpus')
parser.add_argument('--lr', type=str, default='[0.001]*238', help='learning rates for steps(list form)')
...
parser.add_argument('--max-epoch', type=int, default=238, help='maximum iteration to train (default: 100)')
